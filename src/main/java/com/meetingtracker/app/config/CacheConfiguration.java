package com.meetingtracker.app.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("MeetingTracker");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("MeetingTracker");
        ...
        config.getMapConfigs().put("com.meetingtracker.app.domain.*", initializeDomainMapConfig(jHipsterProperties));
